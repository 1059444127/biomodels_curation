...
sim = CopasiSimulator("Lee2010_OneForm_minimal.xml")

data = sim.doTimecourse(end=900, steps=250)

names = {"II":"Prothrombin", "IIa":"Thrombin", "M":"Meizothrombin", "P2":"Prethrombin-2"}
...
plt.savefig("Lee2010_OneForm_minimal.png")
